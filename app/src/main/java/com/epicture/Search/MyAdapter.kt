...
class SearchAdapter(private val myDataset: MutableList<PictureInfoFeed>, private val authentification_data: AuthentificationImgur) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.imageView.setOnClickListener(object: DoubleClickListener() {
            override fun onDoubleClick(v: View) {
                ...
                val animFadein = AnimationUtils.loadAnimation(v.context, R.anim.fade_in_favorites)
